...
namespace BrutalCompanyMinus
{
    ...
    public class Configuration
    {
        ...
        private static void Initalize()
        {
            ...
            Minus.Handlers.FacilityGhost.disableSpikeTrapsWeight = eventConfig.Bind(nameof(FacilityGhost), "Disable spiketraps weight?", 5, "Whenever the ghost makes a decision, what is the weight to attempt to disable the spiketraps?").Value;
